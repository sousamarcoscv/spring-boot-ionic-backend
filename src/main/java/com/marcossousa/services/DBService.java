...
public class DBService {
	...
	public void instantiateTestDataBase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria", "faturamento@mhauto.com.br", "36378912377", TipoCliente.PESSOAFISICA,pe.encode("123"));
		Cliente cli2 = new Cliente(null, "Ana Costa", "sousa.marcoscv@mhauto.com.br", "06902518661", TipoCliente.PESSOAFISICA,pe.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);
		
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		cli2.getTelefones().addAll(Arrays.asList("39350350", "998148034"));
